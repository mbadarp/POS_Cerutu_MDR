...
Public Class CRV_strukjual
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "AppPenjualan.CRV_strukjual.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCRV_strukjual
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CRV_strukjual = New CRV_strukjual()
        rpt.Site = Me.Site
        Return rpt
    End Function
